...
tree -L 2 "$NEW_REPO_DIR" 2>/dev/null || find "$NEW_REPO_DIR" -type f | head -20
echo ""
echo "Next steps:"
...
echo "   cd /home/runner/work/zwift-virtual-shifting/zwift-virtual-shifting"
